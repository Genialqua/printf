...
char *fill_hex_array(char *bnr, char *hex, int isupp, int limit);prinlunt(va_list arguments, char *buf, unsigned int ibuf);
...
int (*get_print_func(const char *s, int index))(va_list, char *, unsigned int)int _printf(const char *format, ...);
int print_prg(va_list __attribute__((unused)), char *, unsigned int);
int print_chr(va_list arguments, char *buf, unsigned int ibuf);
int print_str(va_list arguments, char *buf, unsigned int ibuf);
int print_int(va_list arguments, char *buf, unsigned int ibuf);
